...
/*    provided on Windows 95, Windows NT, and some Unix flavors.      */
...
#if defined _UNIX_LIKE_ && !defined USE_PORTAUDIO
  OSS_WaveInit();
#endif
...
{
#if (!defined _WIN32 && !defined _UNIX_LIKE_) // NAL warning removal
  LPDWORD pdwVol;
#endif
...
#if defined _WIN32 || defined _UNIX_LIKE_
#ifdef USE_PORTAUDIO
#else
