...
/* If the platform has _POSIX_THREADS, activate them in port.h! */
#include "port.h"
...
/**********************************************************************/
/*  POSIX macro to define the thread entry points.                    */
/**********************************************************************/

#define  OP_THREAD_ROUTINE( Routine, Arg )  void* Routine( Arg )

/**********************************************************************/
/*  POSIX threads return type void*, so return a value                */
/**********************************************************************/
...
/**********************************************************************/
/*  POSIX thread priority definitions.                                */
/**********************************************************************/
...
#define  OP_THREAD_ROUTINE( Routine, Arg )  unsigned int __stdcall Routine ( Arg )
