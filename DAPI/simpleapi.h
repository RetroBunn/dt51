...
#define ERR_FILE		4   //Dictionary file or table file open error
...
#define NO_RESET						0x0000
#define HALT_SPEECH_LEAVE_SETTINGS		0x0001
#define RESET_TO_DEFAULT_LANG			0x0002
#define RESET_TO_DEFAULT_VOICE			0x0004
#define RESET_TO_DEFAULT_INLINE_PARAMS	0x0008
#define FULL_ENGINE_RESET				0x000E
#define DT_AVAILABLE 0
#define DT_IN_USE 1
...
extern int TextToSpeechConvertInput(wchar_t *input, int iInType, char * output, int nMaxOut);
...
extern int TextToSpeechReset(int ResetLevel);
