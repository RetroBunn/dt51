...
class SynthDriver(synthDriverHandler.SynthDriver):
	name = "dectalk51"
	description = _("DECtalk 5.1")  # NOQA: F821
	language = None
	supportedSettings = (
	...
	_voices = OrderedDict()
	_voices["Paul"] = {"name": "Paul", "pitch": 122, "inflection": 100}
	_voices["Betty"] = {"name": "Betty", "pitch": 208, "inflection": 240}
	_voices["Harry"] = {"name": "Harry", "pitch": 89, "inflection": 80}
	_voices["Frank"] = {"name": "Frank", "pitch": 155, "inflection": 90}
	_voices["Dennis"] = {"name": "Dennis", "pitch": 110, "inflection": 135}
	_voices["Kit"] = {"name": "Kit", "pitch": 296, "inflection": 180}
	_voices["Ursula"] = {"name": "Ursula", "pitch": 240, "inflection": 135}
	_voices["Rita"] = {"name": "Rita", "pitch": 106, "inflection": 80}
	_voices["Wendy"] = {"name": "Wendy", "pitch": 200, "inflection": 175}
	minInflection = 0
	maxInflection = 250
	minPitch = 50
	maxPitch = 350
	...
	def __init__(self):
		...
		self.player = WavePlayer(1, 10000, 16, outputDevice=config.conf["speech"]["outputDevice"])
