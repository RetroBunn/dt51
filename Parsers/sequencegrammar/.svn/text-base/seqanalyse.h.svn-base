...
/* This include file is for the software that uses the tabled sequences
   that were generated by the sequence compiler.
   Must not be included with software that generates the sequences.
*/

#define DEC_TALK_REWT_DEV      //comment this out if U16 etc are already defined
...
{
    CONST sortcomptrie *sarray;
    CONST U16          numblong;
    CONST U16          *dwnlong;
    CONST U16          numassoc;
    CONST assoctable   *assoc;
}
SortLtrieBlock;
...
struct _walker_context {
    ...
    U16   nnodes;
#endif
    CONST SortLtrieBlock *Ltlist;     // letter trie list.  change
...
BOOL Seq_analyse_word(CONST ASCIILETTER *word, 
		      ASCIILETTER *outword, 
		      ASCIILETTER *outphonemes,
		      U16         *lastrule,
		      WalkCNTXT   *Contxt,
		      CONST grammarinfo *Wt);
