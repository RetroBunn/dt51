...
if /i "%lang%"=="jp"  goto langgood
if /i "%lang%"=="ch"  goto langgood
if /i "%lang%"=="kr"  goto langgood
if /i "%lang%"=="all" (
	set TUNE_ALL=1
	goto langgood
)
...
:tune_all
if "%lang%"=="kr" 	goto end
if "%lang%"=="ch" set lang=kr
if "%lang%"=="jp" set lang=ch
if "%lang%"=="it" set lang=jp
...
:TUNE_IT
copy %length%tune_%lang%.txt ..\..\..\build\dectalk\%lang%\%version%\*
if exist ..\..\swi95nt\%lang%\install\data\as_is\dtalk_%lang%.dic copy ..\..\swi95nt\%lang%\install\data\as_is\dtalk_%lang%.dic ..\..\..\build\dectalk\%lang%\%version%
cd ..\..\..\build\dectalk\%lang%\%version%\
