                    ...
                    DWORD dwDeviceOptions )
{
  ...
  *phAudioWnd = NULL;
  pAudioOpen = (LPAUDIO_OPEN_T)FNX_MALLOC(sizeof(AUDIO_OPEN_T));
  ...
  pWaveFormatLocal = (LPWAVEFORMATEX)FNX_MALLOC( dwWaveFormatSize );
...
static void DestroyAudioObjects( HWND hWnd )
{
  ...
  if ( pAudioParams != NULL )
  {
    ...
    if ( pAudioParams->ppWaveHdr != NULL )
    {
      ...
      FNX_FREE( pAudioParams->ppWaveHdr );
    }
    ...
    if ( pAudioParams->pcsSelectedDeviceID != NULL )
    {
      ...
      FNX_FREE( pAudioParams->pcsSelectedDeviceID );
    }
    ...
    if ( pAudioParams->pcsSamplesPlayed != NULL )
    {
      ...
      FNX_FREE( pAudioParams->pcsSamplesPlayed );
    }
    ...
    FNX_FREE( pAudioParams->pWaveFormat );
...
static LRESULT Process_WM_CREATE_Message( HWND hWnd, LPARAM lParam )
{
  ...
  pAudioParams = (LPAUDIO_PARAMS_T)FNX_MALLOC(sizeof(AUDIO_PARAMS_T));
  ...
  pWaveFormat = (LPWAVEFORMATEX)FNX_MALLOC( dwWaveFormatSize );
  ...
  pAudioQueue = (LPQUEUE_T)FNX_MALLOC(sizeof(QUEUE_T));
...
static MMRESULT GetWaveOutDeviceCaps( LPAUDIO_PARAMS_T pAudioParams )
{
  ...
  pWaveOutCaps = (LPWAVEOUTCAPS)FNX_MALLOC(sizeof(WAVEOUTCAPS));
