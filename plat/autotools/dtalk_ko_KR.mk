#
# dectalk_ko_KR.mk -- makefile fragment for the Korean lib
#

LIBDTALK_KO_KR_CPPFLAGS_FLAGS = -DBUILD_LTS \
$(PLAT_PROC_INCLUDES) \
-I$(top_srcdir)/DAPI \
-I$(top_srcdir)/dapicore/CMD \
-I$(top_srcdir)/dapicore/LTS \
-I$(top_srcdir)/dapicore/LTS/chinese \
-I$(top_srcdir)/dapicore/LTS/korean \
...
LIBDTALK_KO_KR_SOURCE_FILES = \
$(top_srcdir)/dapicore/LTS/l_kr_ad1.c \
$(top_srcdir)/dapicore/LTS/l_kr_con.c \
$(top_srcdir)/dapicore/LTS/l_kr_ma1.c \
$(top_srcdir)/dapicore/LTS/l_kr_pr1.c \
$(top_srcdir)/dapicore/LTS/l_kr_ru1.c \
$(top_srcdir)/dapicore/LTS/l_kr_sp1.c \
...
LIBDTALK_KO_KR_LDFLAGS_FLAGS = -version-info 0:0:0 -export-symbols $(top_srcdir)/plat/unix/sym/language.sym
LIBDTALK_KO_KR_LIBADD_FLAGS = libopthread.la libmmalloc.la $(PTHREAD_LIBS) $(LIBDL)

if BUILD_INTEGER_ENGINE
lib_LTLIBRARIES += libdtalk-integer-ko_KR.la
libdtalk_integer_ko_KR_la_LDFLAGS = $(LIBDTALK_KO_KR_LDFLAGS_FLAGS)
libdtalk_integer_ko_KR_la_LIBADD = $(LIBDTALK_KO_KR_LIBADD_FLAGS)
libdtalk_integer_ko_KR_la_CPPFLAGS = $(DECTALK_DEFINES) -DINTEGER $(KO_KR_DEFINES) $(LIBDTALK_KO_KR_CPPFLAGS_FLAGS)
libdtalk_integer_ko_KR_la_SOURCES = $(LIBDTALK_KO_KR_SRCS)
endif

if BUILD_HLSYN_ENGINE
lib_LTLIBRARIES += libdtalk-hlsyn-ko_KR.la
libdtalk_hlsyn_ko_KR_la_LDFLAGS = $(LIBDTALK_KO_KR_LDFLAGS_FLAGS)
libdtalk_hlsyn_ko_KR_la_LIBADD = $(LIBDTALK_KO_KR_LIBADD_FLAGS)
libdtalk_hlsyn_ko_KR_la_CPPFLAGS = $(DECTALK_DEFINES) -DHLSYN $(KO_KR_DEFINES) $(LIBDTALK_KO_KR_CPPFLAGS_FLAGS)
libdtalk_hlsyn_ko_KR_la_SOURCES = $(LIBDTALK_KO_KR_SRCS)
endif

# End of dectalk_ko_KR.mk
