...
#define US_PH_PHONEME_COUNT 71
#define US_PH_PHONEME_NAMES " _ IY IH EY EH AE AA AY AW AH AO OW OY UH UW RR YU AX IX IR ER AR OR UR W YX R L HX RX LX M N NX EL DZ EN F V TH DH S Z SH ZH P B T D K G DX TX Q CH JH DF TZ CZ LY RE X1 X2 X3 X4 X5 X6 X7 X8 X9 Z1 "
...
// Front
 ...
 350, 	// DX F1 locus
 45, 	// DX percent
 35, 	// DX transition duration
 1740, 	// DX F2 locus
 96, 	// DX percent
 35, 	// DX transition duration
 2350, 	// DX F3 locus
 60, 	// DX percent
 45, 	// DX transition duration
 320, 	// TX F1 locus
 43, 	// TX percent
...
// Round
 ...
 1340, 	// DX F2 locus
 40, 	// DX percent
 75, 	// DX transition duration
 2090, 	// DX F3 locus
 42, 	// DX percent
 100, 	// DX transition duration
 320, 	// TX F1 locus
 43, 	// TX percent
