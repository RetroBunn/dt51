...
/*	  Reset number of accent rises sofar in a phrase if new phrase */
    if ((struccur & FBOUNDARY ) > FPPNEXT) 
		...
		*/ 
			//Using the stress to mark phonemes thT WERE TURNED FROM DOUBLE INTO A SINGLE (LONGER ONE) AND THE STRESS BIT ACTIVATES THE DURATION RULE


		if ((strucstresscur & FSTRESS_1) IS_PLUS)
				{
