...
//    S16 OPENQ;		/* Open quotient */
	...
	*/
	...
	vol_att=int_volume_table[pKsd_t->vol_att]>>3;
...
//#endif
	...
	r2pg = amptable[A2inDB+5 ];  /*  Convert dB to linear */
	r3pg = amptable[A3inDB+5 ];  /*  Convert dB to linear */
...
#else
			 d2pole_cf123( pVtm_t,pKsd_t, &pVtm_t->rnpb, &pVtm_t->rnpc,FNPinHZ , 70 ,18596 );
#endif
#endif
...
void read_speaker_definition(LPTTS_HANDLE_T phTTS) 
{
 ...
 if ( pVtm_t->uiSampleRateChange == SAMPLE_RATE_INCREASE )
	...
	d2pole_pf( pVtm_t,&pVtm_t->R6pb, &pVtm_t->r6pc, f6p, 600, 0 );
