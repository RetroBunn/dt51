...
//#endif
...
#ifndef GERMAN					
					make_f0_command ( phTTS,STEP, 1, pDphsettar->hatsize, delayf0,16, &cumdur, nphon);
#else				
...
#ifndef GERMAN					
						make_f0_command ( phTTS,STEP, 1, (short)(pDphsettar->hatsize), delayf0, 16, &cumdur, nphon); // NAL warning removal
#endif
				...
				if (!pDph_t->special_phrase && (stresscur & FSTRESS_1) IS_PLUS  )
...
//#ifndef GERMAN						 verify with reiner
						make_f0_command ( phTTS,STEP, 3, (short)-f0fall , delayf0, 16, &cumdur, nphon); // NAL warning removal
//#endif
#else
					
				make_f0_command ( phTTS,STEP, 3, (short)+250 , -15, 10, &cumdur, nphon); 
				make_f0_command ( phTTS,STEP, 3, (short)-f0fall , delayf0, 16, &cumdur, nphon); 
#endif
	...
	if ((struccur & FBOUNDARY) == FQUENEXT)
		...
		* to reduce impression of assertive personality */
		...
		if ((phone_feature( pDph_t,pDph_t->allophons[nphon]) & FSYLL) IS_PLUS)
		{
              ...
              targf0 |= 01;*/ /* Must be odd */
              /* Sent.-final unstressed vowel followed by a period */
            make_f0_command (phTTS, GLOTTAL, 5,targf0, (short)(pDph_t->allodurs[nphon]-(NF100MS+NF80MS)), 16, &cumdur, nphon);			
#endif				
				}
		}
#ifdef CUT_THIS_RULE
