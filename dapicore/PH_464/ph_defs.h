...
#define endtyp(b) all_begtyp[(b)>>8][(b)&0xFF]
#define place(b) all_place[(b)>>8][(b)&0xFF]
#define ptram(b) all_ptram[(b)>>8][(b)&0xFF]
#define burdr(b) (all_burdr[(b)>>8][(b)&0xFF])
#define plocu(b) (all_plocu[(b)>>8][(b)&0xFF])
