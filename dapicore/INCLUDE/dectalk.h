...
#ifdef PH_DEBUG
#define PH_DEBUG_2010(x)			if(DT_DBG(PH_DBG,0x010))	FNX_PRINTF(x);
#define PH_DEBUG_2010_P1(x,p1)		if(DT_DBG(PH_DBG,0x010))	FNX_PRINTF(x, p1);
#define PH_DEBUG_2010_P2(x,p1,p2)	if(DT_DBG(PH_DBG,0x010))	FNX_PRINTF(x, p1, p2);
#define PH_DEBUG_2010_P3(x,p1,p2,p3)if(DT_DBG(PH_DBG,0x010))	FNX_PRINTF(x, p1, p2, p3);
#define PH_DEBUG_2080(x)			if(DT_DBG(PH_DBG,0x080))	FNX_PRINTF(x);
#define PH_DEBUG_2080_P1(x,p1)		if(DT_DBG(PH_DBG,0x080))	FNX_PRINTF(x, p1);
#define PH_DEBUG_2080_P2(x,p1,p2)	if(DT_DBG(PH_DBG,0x080))	FNX_PRINTF(x, p1, p2);
#else
#define PH_DEBUG_2010(x)
#define PH_DEBUG_2010_P1(x,p1)
#define PH_DEBUG_2010_P2(x,p1,p2)
#define PH_DEBUG_2010_P3(x,p1,p2,p3)
#define PH_DEBUG_2080(x)
#define PH_DEBUG_2080_P1(x,p1)
#define PH_DEBUG_2080_P2(x,p1,p2)
#endif
