...
#define LANG_english_abbrev			"US"
#define LANG_french_abbrev			"FR"
#define LANG_german_abbrev			"GR"
#define LANG_spanish_abbrev			"SP"
#define LANG_japanese_abbrev			"JP"
#define LANG_british_abbrev			"UK"
#define LANG_latin_american_abbrev		"LA"
#define LANG_italian_abbrev			"IT"
#define LANG_korean_abbrev			"KR"
#define LANG_chinese_abbrev			"CH"
#define LANG_hebrew_abbrev			"HB"
 ...
 */
#ifdef USE_NAND
	volatile        S32                *fdic_index;			/* pointer to installed dictionarys */
	volatile        unsigned char      *fdic_data;           /* pointer to installed dictionarys */
	volatile        S32                fdic_entries;         /*   total entries in dictionarys */
	volatile        S32                fdic_bytes;           /*   total entries in dictionarys */
#ifdef CHEESY_DICT_COMPRESSION
	volatile        S32                *fdic_fc_entry;         /*   total entries in dictionarys */
	volatile        S32                fdic_fc_entries;         /*   total entries in dictionarys */
#endif

	volatile        S32                *udic_index;          /* pointer to installed dictionarys */
	volatile        unsigned char      *udic_data;           /* pointer to installed dictionarys */
	volatile        S32                udic_entries;         /*   total entries in dictionarys */
	volatile        S32                udic_bytes;           /*   total entries in dictionarys */
	volatile		DT_HANDLE fdicFileHandle;
	volatile		DT_HANDLE grfdicFileHandle;
#else
