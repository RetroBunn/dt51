                ...
                )
{
  ...
  PhaseIncrement_0 = (float)(0.25 * TWO_PI_EQUIVALENT / (float)iRiseSamples);
  Phase_0 = 0.0;
  ...
  {
    Sample = (float)SineTable[(int)Phase_0];
    *pRise++ = Sample * Sample;
  ...
  PhaseIncrement_0 = (float)(Freq_0 * pKsd_t->SamplePeriod * TWO_PI_EQUIVALENT);
  Phase_0 = 0.0;
  PhaseIncrement_1 = (float)(Freq_1 * pKsd_t->SamplePeriod * TWO_PI_EQUIVALENT);
  Phase_1 = 0.0;
...
static float Tone( float PhaseIncrement, float * pPhase )
{
  ...
  Sample = (float)SineTable[(int)*pPhase];
