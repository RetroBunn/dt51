...
#endif // defined (WIN32) || defined (_UNIX_LIKE_) || defined ARM7
}
...
#ifdef NEW_MULTI_LANG_ARCH
	phTTS->lts_funcs[phTTS->cur_lts_lang]->lts_loop(phTTS,&pipe_value);
#else
	lts_loop(phTTS,&pipe_value);
#endif
	return(CMD_success);
			...
			case 0:    /* First param */
				...
				{                               
					...
					case 9: /* email reading mode */
						...
						break;
					case 10: /* email reading mode */
						pipe_value[2] |= MODE_INTONREV;
						break;
					case 11:
						pipe_value[2] |= MODE_CASIO1;
						break;
					case 12:
						pipe_value[2] |= MODE_CASIO2;
						break;
					case 13:
						pipe_value[2] |= MODE_CASIO3;
						break;
					default:
						return(CMD_bad_param);
				}
