...
const unsigned char p0then[] = {
	SIL
/* no translation */
};
 
const unsigned char p1sten[] = {
	GR_Q, S1, GR_EH, GR_R, GR_S, GR_T, GR_EX, GR_N, SIL
};

const unsigned char p2nden[] = {
	S1,	GR_TS,	GR_V,	GR_EI,	GR_T,	GR_EX, GR_N,
	SIL
};
 
const unsigned char p3rden[] = {
	S1,	GR_D,	GR_RR,	GR_I,	GR_T,	GR_EX, GR_N,
	SIL
};
 
const unsigned char p4then[] = {
	S1,	GR_F,	GR_IH,	GR_R,	GR_T,	GR_EX, GR_N,
	SIL
};
 
const unsigned char p5then[] = {
	S1,	GR_F,	GR_UE,	GR_N,	GR_F,	GR_T,	GR_EX,  GR_N,
	SIL
};
 
const unsigned char p6then[] = {
	GR_Z,	S1,	GR_E,	GR_K,	GR_S,	GR_T,	GR_EX, GR_N,
	SIL
};
 
const unsigned char p7then[] = {
	GR_Z,	S1,	GR_IH,	GR_P,	GR_T,	GR_EX, GR_N,
	SIL
};
 
const unsigned char p8then[] = {
	GR_Q,	S1,	GR_A,	GR_KH,	GR_T,	GR_EX, GR_N,
	SIL
};
 
const unsigned char p9then[] = {
	GR_N,	S1,	GR_EU,	GR_N,	GR_T,	GR_EX, GR_N,
	SIL
};
 
const unsigned char *CONSTCONST pordinen[] = {
	p0then,  p1sten,  p2nden,  p3rden,  p4then,
	p5then,  p6then,  p7then,  p8then,  p9then
};
 

const unsigned char p0the[] = {
	SIL
/* no translation */
};
 
const unsigned char p1ste[] = {
	GR_Q, S1, GR_EH, GR_R, GR_S, GR_T, GR_EX, SIL
};

const unsigned char p2nde[] = {
	S1,	GR_TS,	GR_V,	GR_EI,	GR_T,	GR_EX, 
	SIL
};
 
const unsigned char p3rde[] = {
	S1,	GR_D,	GR_RR,	GR_I,	GR_T,	GR_EX, 
	SIL
};
 
const unsigned char p4the[] = {
	S1,	GR_F,	GR_IH,	GR_R,	GR_T,	GR_EX, 
	SIL
};
 
const unsigned char p5the[] = {
	S1,	GR_F,	GR_UE,	GR_N,	GR_F,	GR_T,	GR_EX,  
	SIL
};
 
const unsigned char p6the[] = {
	GR_Z,	S1,	GR_E,	GR_K,	GR_S,	GR_T,	GR_EX, 
	SIL
};
 
const unsigned char p7the[] = {
	GR_Z,	S1,	GR_IH,	GR_P,	GR_T,	GR_EX, 
	SIL
};
 
const unsigned char p8the[] = {
	GR_Q,	S1,	GR_A,	GR_KH,	GR_T,	GR_EX, 
	SIL
};
 
const unsigned char p9the[] = {
	GR_N,	S1,	GR_EU,	GR_N,	GR_T,	GR_EX,
	SIL
};
 
const unsigned char *CONSTCONST pordine[] = {
	p0the,  p1ste,  p2nde,  p3rde,  p4the,
	p5the,  p6the,  p7the,  p8the,  p9the
};
...
const unsigned char pstexn[] = {
	GR_S,	GR_T,	GR_EX, GR_N, SIL
};

const unsigned char ptexn[] = {
	GR_T,	GR_EX,   GR_N, SIL
};
...
const unsigned char e_ending_words[] = {
		5,'d','a','s',GGEOS,SIL,
		5,'d','i','e',GGEOS,SIL,                                
		5,'d','e','r',GGEOS,SIL,                                
        0
...
const unsigned char en_ending_words[] = {
		4,'a','m',GGEOS,SIL,
		5,'d','e','m',GGEOS,SIL,                                
		5,'d','e','s',GGEOS,SIL,                                
		6,'b','e','i','m',GGEOS,SIL,                                
