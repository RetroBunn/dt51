...
#ifdef ITALIAN
extern const unsigned char ponethousand[];
...
#ifdef ITALIAN
extern const unsigned char peuros[];
#endif
...
extern const unsigned char p5h[];
extern const unsigned char p6h[];
extern const unsigned char p8h[];
extern const unsigned char p10h[];
extern const unsigned char *CONSTCONST punitsh[];
extern const unsigned char *CONSTCONST pteensh[];
extern const unsigned char *CONSTCONST ptensh[];  
...
extern const unsigned char pstexn[];
extern const unsigned char ptexn[];
...
extern const unsigned char e_ending_words[];
extern const unsigned char en_ending_words[];
extern const unsigned char p0the[];
extern const unsigned char p1ste[];
extern const unsigned char p2nde[];
extern const unsigned char p3rde[];
extern const unsigned char p4the[];
extern const unsigned char p5the[];
extern const unsigned char p6the[];
extern const unsigned char p7the[];
extern const unsigned char p8the[];
extern const unsigned char p9the[];
extern const unsigned char *CONSTCONST pordine[];
extern const unsigned char p0then[];
extern const unsigned char p1sten[];
extern const unsigned char p2nden[];
extern const unsigned char p3rden[];
extern const unsigned char p4then[];
extern const unsigned char p5then[];
extern const unsigned char p6then[];
extern const unsigned char p7then[];
extern const unsigned char p8then[];
extern const unsigned char p9then[];
#ifdef OS_PALM
extern const unsigned char * pordinen[];
#else
extern const unsigned char *const pordinen[];
#endif
#endif
