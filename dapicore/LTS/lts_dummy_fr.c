...
void fr_lts_loop(LPTTS_HANDLE_T phTTS,unsigned short *input)
{
}
...
#endif
CONST lts_func_t fr_lts_func = {

	LANG_french,
   /*lts_func->pLTSThreadData=*/  //NULL,


   /*lts_func->lts_loop=*/  fr_lts_loop ,
...
CONST lts_func_t *fr_ls_main_get_lts_funcs(void)
{
#ifdef WIN32_STATIC
	return(NULL);
#else
