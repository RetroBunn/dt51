...
#ifdef USE_NAND
extern  int ls_dict_file_system_lookup(LPTTS_HANDLE_T phTTS, int *pLocaloff, struct dic_entry  *pent);
#endif
...
extern  struct dic_entry __far *ls_homo_homo_464(LPTTS_HANDLE_T phTTS, long index);
...
#elif defined (FRENCH)
extern void ls_proc_do_digit_group(LPTTS_HANDLE_T phTTS, unsigned char buf[3], int oflag,int cflag);
#endif
...
extern void ls_util_send_asky_phone_list(LPTTS_HANDLE_T phTTS, const unsigned char *pp);
