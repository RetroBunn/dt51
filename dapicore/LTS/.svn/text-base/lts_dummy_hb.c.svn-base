...
void hb_lts_loop(LPTTS_HANDLE_T phTTS,unsigned short *input)
{
}
...
CONST lts_func_t hb_lts_func = {

	LANG_hebrew,
   /*lts_func->pLTSThreadData=*/  //NULL,


   /*lts_func->lts_loop=*/  hb_lts_loop ,
...
CONST lts_func_t *hb_ls_main_get_lts_funcs(void)
{
#ifdef WIN32_STATIC
	return(NULL);
#else
