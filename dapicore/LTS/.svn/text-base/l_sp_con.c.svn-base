...
const unsigned char p30[] = {
	SP_T,    SP_R,     S1,    SP_E,    SP_I,    SP_N,    SBOUND,
	SP_T,    SP_A,     SIL
};

const unsigned char p40[] = {
	SP_K,    SP_U,    SP_A,    SBOUND, SP_R,  S1,  SP_E,    SP_N,
	SBOUND, SP_T,    SP_A,     SIL
};

const unsigned char p50[] = {
	SP_TH,   SP_I,    SP_N,    SBOUND, SP_K,    SP_U,    S1,   SP_E,
	SP_N, SBOUND,    SP_T,    SP_A,     SIL
};

const unsigned char p60[] = {
	SP_S,    SP_E,    SBOUND, SP_S,   S1,   SP_E,    SP_N,    SBOUND,
	SP_T,    SP_A,     SIL
};

const unsigned char p70[] = {
	SP_S,    SP_E,    SBOUND, SP_T,   S1,    SP_E,    SP_N,    SBOUND,
	SP_T,    SP_A,     SIL
};

const unsigned char p80[] = {
	SP_O,    SBOUND, SP_CH,   S1,     SP_E,    SP_N,    SBOUND,
	SP_T,    SP_A,     SIL
};

const unsigned char p90[] = {
	SP_N,    SP_O,SBOUND,     SP_BH,   S1,      SP_E,    SP_N,SBOUND,     SP_T,    SP_A,     SIL
};
...
const unsigned char peuro[] = {
	WBOUND, S1, SP_E, SP_U, SBOUND, SP_R, SP_O, SIL
};
