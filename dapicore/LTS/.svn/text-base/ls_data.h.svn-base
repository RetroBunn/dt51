...
#if defined KOREAN || defined(SPANISH) || defined EPSON_ARM7 || defined MULTIPLE_LANGUAGES_LOADED
#include "FnxLtsRulesEngine.h"
#endif

#if defined CHINESE || defined EPSON_ARM7 || defined MULTIPLE_LANGUAGES_LOADED
...
#define PRO_TO			0x00000400
#define PRO_MULTI_CONJ	0x00000200
#define PRO_WHOW		0x00000800

#define PRO_PREP_BREAK	0x00100000
#define PRO_VERB_PHRASE 0x00200000
#define PRO_OPT_BREAK	0x00400000
#define PRO_REQ_BREAK	0x00800000


#define E_WORD	0x0001
#define EN_WORD	0x0002
#define ER_WORD	0x0004
...
#if defined GERMAN || defined ITALIAN || defined EPSON_ARM7 || defined MULTIPLE_LANGUAGES_LOADED
union walkerunion {
#if defined GERMAN || defined EPSON_ARM7 || defined MULTIPLE_LANGUAGES_LOADED
...
// eab updated for bts10187 new junk node
//	HPatterns	*bachus_trennung;	
//	IT_WalkCNTXT IT_Walkercntxt; //moved into walkerunion
...
#ifdef USE_NAND
	struct dic_entry *homo_primary, *homo_secondary;
#endif //USE_NAND
...
//	int		current_word_pos;
	...
	LETTER  pword[NGWORD];                  /* previous word.                     */
	int 	tlflag;  
	int		sign;
	int		lbphone;
	int		rbphone;
...
#if defined CHINESE || defined EPSON_ARM7 || defined MULTIPLE_LANGUAGES_LOADED
	Hanzi *pPolyPhoneTable;			//  pointer to head of Hanzi in context data
#endif

	int reduce_number_stress;
