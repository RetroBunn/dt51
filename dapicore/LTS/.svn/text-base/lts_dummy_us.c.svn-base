...
void us_lts_loop(LPTTS_HANDLE_T phTTS,unsigned short *input)
{
}
...
CONST lts_func_t us_lts_func = {

	LANG_english,
   /*lts_func->pLTSThreadData=*/  //NULL,


   /*lts_func->lts_loop=*/  us_lts_loop ,
...
CONST lts_func_t *us_ls_main_get_lts_funcs(void)
{
#ifdef WIN32_STATIC
	return(NULL);
#else
