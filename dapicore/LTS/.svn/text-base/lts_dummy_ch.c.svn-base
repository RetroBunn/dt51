...
void ch_lts_loop(LPTTS_HANDLE_T phTTS,unsigned short *input)
{
}
...
CONST lts_func_t ch_lts_func = {

	LANG_chinese,
   /*lts_func->pLTSThreadData=*/  //NULL,


   /*lts_func->lts_loop=*/  ch_lts_loop ,
...
CONST lts_func_t *ch_ls_main_get_lts_funcs(void)
{
#ifdef WIN32_STATIC
	return(NULL);
#else
