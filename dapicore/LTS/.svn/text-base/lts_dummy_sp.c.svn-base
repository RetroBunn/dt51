...
void sp_lts_loop(LPTTS_HANDLE_T phTTS,unsigned short *input)
{
}
...
#endif
CONST lts_func_t sp_lts_func = {

	LANG_spanish,
   /*lts_func->pLTSThreadData=*/  //NULL,


   /*lts_func->lts_loop=*/  sp_lts_loop ,
...
CONST lts_func_t *sp_ls_main_get_lts_funcs(void)
{
#ifdef WIN32_STATIC
	return(NULL);
#else
