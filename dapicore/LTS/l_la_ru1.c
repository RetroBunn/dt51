...
const static  char fonemequiv[] = {
      ...
      /* P .. W */   LA_P,   NOVALID,NOVALID,NOVALID,LA_T,   NOVALID,LA_V,   NOVALID,
 ...
 * OUT:		sOut - string
 * RETURN:	length of sOut on success, 0 on failure
 * NOTES:	
 *END_HEADER***************************/
int ConvertToAscii(void *pVoid, void *lpVoid, char *sOut, int iInType)
{
	return 0;
}