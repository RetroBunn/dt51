...
void kr_lts_loop(LPTTS_HANDLE_T phTTS,unsigned short *input)
{
}
...
CONST lts_func_t kr_lts_func = {

	LANG_korean,
   /*lts_func->pLTSThreadData=*/  //NULL,


   /*lts_func->lts_loop=*/  kr_lts_loop ,
...
CONST lts_func_t *kr_ls_main_get_lts_funcs(void)
{
#ifdef WIN32_STATIC
	return(NULL);
#else
